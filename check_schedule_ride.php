...
function update_firebase_order($order_id,$captain_id){
  ...
  car_detail.car_colour , car_detail.car_number_plate , tracking.latitude , tracking.longitude
  ...
  $newJsonString = json_encode($riderObject);
   ...
   $firebase_url = "https://kareem-taxi-app.firebaseio.com/order/"."$order_id"."/riderObject.json";
